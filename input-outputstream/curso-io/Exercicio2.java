...
public class Exercicio2{
    public static void abrirTecladoEscreverDocumento() throws IOException {
        ...
        //tudo isso acima poderia ser feito com System.out.println, são varias formas de fazer
        ...
        /*Writer w = new FileWriter(f.getName()); //criando o documento recomendacoes.txt, Writer é uma classe abstrata, fileWriter extende dela
        BufferedWriter bw = new BufferedWriter(w);*/

        //criando um buffer interno para armazenar os characters em vez de gravar diretamente no arquivo.
        //assim que buffer preenchido ou o gravador fechado, todos os characters do buffer são gravados no arquivo.
        BufferedWriter bw = new BufferedWriter(new FileWriter(f.getName())); //outra forma, mais resumida que nas linhas 22 e 23

        do {
            bw.write(line); //escreva no buffer interno a linha capturada pelo scanner, bw vai escrever no objeto que ele recebeu no caso é FileWriter(f.getName()) ou seja no arquivo
