...
import org.example.classes.IntefaceImprimir;
...
public class Main implements IntefaceImprimir<Imovel>{
    public static void main(String[] args) {
        ...
        new Main().imprimir(imovel);
    }

    @Override
    public void imprimir(Imovel imovel) {
